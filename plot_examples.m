...
%plot raw signals
h1 = figure(1);clf
title(['Signals n�',num2str(index_Data_Demo(1)),' ',num2str(index_Data_Demo(2)),' ', num2str(index_Data_Demo(3)),' ',num2str(index_Data_Demo(4)) ])n=length(index_Data_Demo)
for i = 1:n
    subplot(4,1,i)
...
h3 = figure(3);
h=title(['FFTR Windowed signals n°',num2str(index_Data_Demo(1)),' ',num2str(index_Data_Demo(2)),' ', num2str(index_Data_Demo(3)), ' ',num2str(index_Data_Demo(4)) ]);
for i = 1:n
    subplot(4,1,i)
...
h4 = figure(4);
h=title(['FFTR Filtered signals n°',num2str(index_Data_Demo(1)),' ',num2str(index_Data_Demo(2)),' ', num2str(index_Data_Demo(3)), ' ',num2str(index_Data_Demo(4)) ]);
for i = 1:n
    subplot(4,1,i)
...
h5 = figure(5);
h=title(['FFTR WinFilted signals n°',num2str(index_Data_Demo(1)),' ',num2str(index_Data_Demo(2)),' ', num2str(index_Data_Demo(3)), ' ',num2str(index_Data_Demo(4)) ]);
for i = 1:n
    subplot(4,1,i)
